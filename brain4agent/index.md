...
| Kế hoạch hiện tại | planning/10_2026-09-16_release-readiness-hardening | [Plan 10](../planning/10_2026-09-16_release-readiness-hardening/plan.md) — local acceptance complete and clean GitHub Actions run `35060225165` passed end-to-end on Node 24/Python 3.11; Turso preview & staging schemas reconciled; Vercel preview deployed Ready with fenced writes |
