...
| **Kế hoạch đang chạy** | planning/14_2026-09-18_voice-ai | [Plan14](../planning/14_2026-09-18_voice-ai/plan.md) — Voice AI: văn bản nói chuẩn hoá, chính sách giọng chọn lọc, `voiceScript` do server dựng, STT trình duyệt, `/api/voice/pronunciation`; LOCAL ACCEPTED 2026-09-18, chưa commit; [ADR 0002](../docs/adr/0002-voice-ai.md) |
...
| Audio / Voice AI | core/tts; core/voice; features/voice; server/voice; api/voice; components/providers; tts-service | [ADR 0001](../docs/adr/0001-tts-engine.md), [ADR 0002](../docs/adr/0002-voice-ai.md) |
