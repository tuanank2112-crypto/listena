...
| **Kế hoạch đang chạy (worker)** | planning/16_2026-09-18_voice-rollout | [Plan16](../planning/16_2026-09-18_voice-rollout/plan.md) — rollout Voice AI: commit/CI Plan15 → doctor với key thật → env Vercel + deploy + smoke → chi phí → bump 0.8.0 → đồng bộ não; PATCH chỉ plan.md; worker làm theo thứ tự WP, ledger trong plan |
...
| Audio / Voice AI | core/tts; core/voice; features/voice; server/voice; api/voice; components/providers; tts-service | [ADR 0001](../docs/adr/0001-tts-engine.md), [ADR 0002](../docs/adr/0002-voice-ai.md), [ADR 0003](../docs/adr/0003-elevenlabs-voice.md) |
...
- src/core: assessment/text, games/scoring, learner model, recommendation, SM-2, TTS, voice (spoken-text, voice-policy, voice-script, pronunciation, speech-recognition). src/features/voice: preferences, mic button, settings, repeat-after-me. src/server/voice: pronunciation service.
