...
## Ưu tiên tiếp theo
1. Record one bounded, persisted personalized-lesson smoke against the deployed Kira binding; then observe quota/cost/latency before expanding live generation. OpenAI remains an explicit alternate path, not a Kira URL override.
